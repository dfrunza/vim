...
" Pyrex extentions
syn keyword pyrexStatement      cdef cpdef typedef ctypedef sizeof nogil gil
syn keyword pyrexType		int long short float double char object void str 
syn keyword pyrexType		signed unsigned const
